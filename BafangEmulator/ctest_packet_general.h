...
TEST(request_packet_general_size_test)
{
  EXPECT_EQ(sizeof(core::request_general), 1);
}

TEST(request_packet_general_serialize_test)
{
...
TEST(response_packet_general_size_test)
{
  EXPECT_EQ(sizeof(core::response_general), 16);
}

TEST(response_packet_general_serialize_test)
{
...
TEST(request_packet_general_deserialize_test)
{
  auto test = []
  {
...
TEST(response_packet_general_deserialize_test)
{
  auto test = []
  {
    std::string actual = {
